...
const AddRecord = ({navigation}) => {
  ...
  const recordRequest = async () => {
    ...
    const config = {
      method: 'post',
      url: 'https://vast-pink-crane-hem.cyclic.app/wallet/record_request',
      headers: {
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Text
                style={{fontSize: 14, fontWeight: 'bold', color: '#F8F8F8'}}>
                Cancel
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View
            ...
            <Text style={{fontSize: 22, fontWeight: 'bold', color: '#F8F8F8'}}>
              {selected == 'Expense' ? '-250.5' : '+600.5'}
            </Text>
          </View>
        </View>
      </View>
