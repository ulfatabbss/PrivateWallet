  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Image resizeMode='contain' style={styles.icon} source={require('../assets/backErrow.png')}/>
<Text style={{color:'#233A6B',fontSize:24,fontWeight:'bold'}}>Recent Transactions</Text>
      </View>
      <FlatList
